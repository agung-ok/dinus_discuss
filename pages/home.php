...
<body>
    ...
    <div class="panel panel-success">
                    ...
                    <h3 class="panel-title">Diskusi Baru</h3>
                    </div>
            ...
            $sel = mysql_query("SELECT * from tblpost as tp join category as c on tp.cat_id=c.cat_id order by datetime desc limit $start_from, $num_rec_per_page" );
            ...
            ?>
                    ...
                    echo  '<a href="home.php?page=1"><span aria-hidden="true">&laquo;</span></a></li>'; // Goto 1st page  
                    for ($i=1; $i<=$total_pages; $i++) { 
                    echo '<li>';
                    echo '<a href="home.php?page='.$i.'">'.$i.'<span class="sr-only">(current)</span></a></li> '; 
                    }; 
                    echo '<li class="next">';
                    echo '<a href="home.php?page='.$total_pages.'"><span aria-hidden="true">&raquo;</span></a></li> '; // Goto last page
                   echo '
                    </div>
                    </ul>
                    </nav>'; // Goto last page
